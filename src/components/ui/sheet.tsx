...
/** A side drawer built on Radix Dialog. */
...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-popover shadow-xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-300',
  {
    variants: {
      side: {
